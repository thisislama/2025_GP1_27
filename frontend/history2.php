...
<div class="wrapper">
    ...
    <form method="POST" id="deleteForm">
      ...
      // Tooltip data for waveform patterns (matching anomalyInfo)
$tooltip_data = [
    'double trigger' => 'Double triggering occurs when two continuous ventilatory inspiratory efforts are initiated by the patient, with insufficient expiratory time between them',
    'accumulation flow' => 'Accumulation occurs when incomplete exhalation leads to air trapping, resulting in intrinsic positive end-expiratory pressure (auto-PEEP), which increases the effort required to trigger the ventilator',
    'leak' => 'Leakage occurs when air escapes from the ventilator circuit, leading to patient–ventilator dyssynchrony',
    'premature_cycling flow' => 'Premature cycling occurs when the ventilator ends the inspiratory phase earlier than the patient\'s inspiratory effort is completed, causing a mismatch between patient demand and ventilator support',
    'premature_cycling volume' => 'Premature cycling occurs when the ventilator ends the inspiratory phase earlier than the patient\'s inspiratory effort is completed, causing a mismatch between patient demand and ventilator support',
    'ineffective effort' => 'Ineffective effort occurs when the patient generates an inspiratory effort that fails to trigger the ventilator, resulting in missed breaths and patient–ventilator dyssynchrony',
    'normal flow' => 'Flow waveform within normal pattern.',
    'normal volume' => 'Volume waveform within normal pattern.',
    'normal pressure' => 'Pressure waveform within normal pattern.'
];
