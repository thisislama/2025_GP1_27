...
.file-icon {
    width: 36px;
    height: 36px;
    background: linear-gradient(135deg, #e9eff7 0%, #d4e1f5 100%);
    border-radius: 8px;
    display: flex;
    align-items: center;
...
<div class="wrapper">
    ...
    <div class="file-item" onclick="window.location.href='patient.html?pid=P001'">
        <div class="file-header">
            ...
            <div class="patient-data">
                ...
                <div class="file-id">P-20119-2112</div>
        ...
        <div class="patient-details">
            <div class="detail-item">
                <span class="material-symbols-outlined" style="font-size:14px; margin-left:8px;">Account_Circle
                </span>
                Patine name: John Doe
